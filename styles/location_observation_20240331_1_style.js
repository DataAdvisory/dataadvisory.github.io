var size = 0;
var placement = 'point';
function categories_location_observation_20240331_1(feature, value, size, resolution, labelText,
...
case '600':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(43,131,186,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_location_observation_20240331_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("quality_code");
    var labelText = "";
    size = 0;
...
var style = categories_location_observation_20240331_1(feature, value, size, resolution, labelText,
